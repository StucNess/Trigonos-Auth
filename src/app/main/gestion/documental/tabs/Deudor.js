...
import { usePostFacturacionDeudorMutation } from "app/store/instrucciones/instruccionesApi";
...
export default function Deudor(props) {
  ...
  const [postFacturacionDeudor] = usePostFacturacionDeudorMutation(); // CALL API
  //
  // FUNCIONES
    ...
    <div className="grid grid-cols-9 gap-12 p-[20px]">
      <div className="col-span-3 bg-white rounded-md">
        ...
        <div className="p-[20px]">
          ...
          <Disponible cliente={props.cliente} acreedor={false} />
        </div>
      </div>
