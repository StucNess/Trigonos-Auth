...
const schema = yup.object().shape({
  ...
  acceptTermsConditions: yup.boolean().oneOf([true], 'Los terminos y condiciones deben ser aceptados'),
  project:yup.string().required('Debe seleccionar un proyecto').oneOf(['1', '2'], 'No esta disponible ese proyecto'),
});
