      ...
      content={ <Box className="flex flex-col w-full  p-[20px]">
        <Box className="  bg-white rounded-sm p-[10px] mb-[20px]">
              ...
              <Box   className="flex flex-auto bg-white rounded-sm bg-grey-300 m-[10px] p-[10px]"  >
                ...
                <div>
                <span className="text-grey-700">Introducir términos de búsqueda en los <b>filtros</b> superiores para encontrar al <b>cliente</b> que desee luego puede proceder a modificar sus datos asociados.</span>
                </div>
