...
export default function TablaUltimosCambios(props) {
  ...
  const [getDataHist, {isLoading : isLoadingHist}] = useGetHistorificacionMutation();
  ...
  function getHistData(){
    setLoadingApis(true);
    getDataHist({id:props.idParticipant, PageIndex:pageIndex, PageSize:rowsPerPage  }).then((response)=>{
      ...
      if(response.data){
        ...
        setDataRows(data.map(function (el) {
          return {id: el.id, 
            ...
            coleccion_campos: 
              (el.name_old != 0 || el.name_old != "0" ? "[ Nombre ] " : "") +
              (el.rut_old != 0 || el.rut_old != "0" ? " [ Rut ] " : "") +
              (el.verification_code_old != 0 || el.verification_code_old != "0"
                ? "[ Token ]"
                : "") +
              (el.business_name_old != 0 || el.business_name_old != "0"
                ? "[ Razón Social ]"
                : "") +
              (el.commercial_business_old != 0 || el.commercial_business_old != "0"
                ? "[ Giro ]"
                : "") +
              (el.dte_reception_email_old != 0 || el.dte_reception_email_old != "0"
                ? "[ Email DTE ]"
                : "") +
              ...
              (el.commercial_address_old != 0 || el.commercial_address_old != "0"
                ? "[ Dirección Comercial ]"
                : "") +
              ...
              (el.pay_contact_first_name_old != 0 ||
                ...
                : "") +
              (el.pay_contact_last_name_old != 0 || el.pay_contact_last_name_old != "0"
                ? "[ Apellido Contacto Pago ]"
                : "") +
              (el.pay_contact_address_old != 0 || el.pay_contact_address_old != "0"
                ? "[ Dirección Contacto Pago ]"
                : "") +
              (el.pay_contact_phones_old != 0 || el.pay_contact_phones_old != "0"
                ? "[ Teléfono Contacto Pago ]"
                : "") +
              (el.pay_contact_email_old != 0 || el.pay_contact_email_old != "0"
                ? "[ Email Contacto Pago ]"
                : "") +
              ...
              (el.bills_contact_last_name_old != 0 ||
                ...
                : "") +
              (el.bills_contact_address_old != 0 || el.bills_contact_address_old != "0"
                ? "[ Direccion Contacto Factura ]"
                : "") +
              (el.bills_contact_phones_old != 0 || el.bills_contact_phones_old != "0"
                ? "[ Teléfono Contacto Factura ]"
                : "") +
              (el.bills_contact_email_old != 0 || el.bills_contact_email_old != "0"
