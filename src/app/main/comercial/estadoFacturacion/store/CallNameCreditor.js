...
let prueba = [];
export const CallNameCreditor = async (id = 141, data, filters) => {
  let url = "";
  // let acreedorid = "";
  // let deudorid = "";
  let params = {
  ...
  url =
    `
    http://164.77.112.10:99/sFiltrosNameCreditor?id=${id}&FechaEmision=${params.fechaEmision}&FechaRecepcion=${params.fechaRecepcion}&` +
