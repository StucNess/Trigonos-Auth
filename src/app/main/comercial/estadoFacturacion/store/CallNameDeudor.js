...
let prueba = [];
export const CallNameDeudor = async (id = 141, data, filters) => {
  let url = "";
  // let acreedorid = "";
  // let deudorid = "";
  let params = {
  ...
  url =
    `
    https://trigonosapi.azurewebsites.net/sFiltrosNameDebtor?id=${id}&FechaEmision=${params.fechaEmision}&FechaRecepcion=${params.fechaRecepcion}&` +
