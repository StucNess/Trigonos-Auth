...
let prueba = [];
export const CallRutDeudor = async (id = 141, data, filters) => {
  let url = "";
  // let acreedorid = "";
  // let deudorid = "";
  let params = {
  ...
  url =
    `
    https://trigonosapi.azurewebsites.net/sFiltrosRutDeudor?id=${id}&FechaEmision=${params.fechaEmision}&FechaRecepcion=${params.fechaRecepcion}&` +
