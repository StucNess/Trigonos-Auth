...
let prueba = [];
export const CallRutCreditor = async (id = 141, data, filters) => {
  let url = "";
  // let acreedorid = "";
  // let deudorid = "";
  let params = {
  ...
  url =
    `
    https://trigonosapi.azurewebsites.net/sFiltrosRutCreditor?id=${id}&FechaEmision=${params.fechaEmision}&FechaRecepcion=${params.fechaRecepcion}&` +
