      ...
      content={ <Box className="flex flex-col w-full  p-[20px]">
        <Box className="  bg-white rounded-sm p-[10px] mb-[20px]">
              ...
              <Box   className="flex flex-auto bg-white rounded-sm bg-grey-300 m-[10px] p-[10px]"  >
                ...
                <div>
                <span className="text-grey-700">Primero selecciona un <b>Cliente</b>, segundo revisa sus <b>Instrucciones</b> y descarga su folio, tercero sube el <b>Folio</b> y por último finaliza el proceso </span>
                </div>
